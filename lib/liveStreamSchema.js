...
export const STREAM_PURCHASES_COLLECTION = {
  ...
  attributes: [
    ...
    { key: "amount", type: "Float", required: true, note: "Dollars — do NOT set min/max in Appwrite (supports $0.99–$999.99)" },
    ...
    { key: "purchasedAt", type: "DateTime", required: true, note: "Set at checkout start; updated when payment completes" },
  ],
  indexes: [
    {
