...
export const VIDEOSDK_CONFIG = {
  ...
  // Required for reliable App Store / Play Store behavior: your HTTPS endpoint that returns { token }.
  // Example path often used: GET /get-token?meetingId=... — see lib/videosdkHelper.js
  tokenServerUrl: null,
