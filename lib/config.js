...
if (envTokenUrl && envRoomUrl && envTokenUrl !== envRoomUrl) {
  console.warn(
    "⚠️ VideoSDK token URL and room URL differ. Ensure both backends use the same VideoSDK project credentials to avoid iOS live start failures."
  );
}
