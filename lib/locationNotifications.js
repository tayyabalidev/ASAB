...
function recipientsForShareStarted(user, privacyMode, allowedViewerIds) {
  ...
  // Friends + Everyone: notify people you follow, who follow you, and invite partners.
  return getConnectedUserIds(user, allowedViewerIds);
}
...
export async function inviteUserToShareLocation({ fromUser, toUserId }) {
  ...
  await addLocationSharePartner(fromUser.$id, toUserId);
