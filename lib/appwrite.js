  ...
  try {
    ...
    if (currentUser && currentUser.documents.length > 0) {
      ...
      try {
        ...
        console.error("Error fetching user photos:", e);
      }
    ...
    try {
      ...
      console.error("Note: Account identity may remain, but all app data has been deleted:", e);
    }
...
export async function toggleLike(userId, postId) {
  try {
    ...
    if (isLiked) {
      ...
      console.log('Creating like:', { userId, postId, collectionId: appwriteConfig.likesCollectionId });
